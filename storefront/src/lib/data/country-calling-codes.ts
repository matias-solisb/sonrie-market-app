// Lista de países (ISO 3166-1 alpha-2) con su código telefónico (E.164),
// para el selector de bandera/código del campo Teléfono en `ProfileCard`.
// No depende de ninguna librería externa (evita agregar una dependencia
// nueva solo para esto) — son datos públicos (ISO + UIT), no contenido con
// copyright.
...
export const COUNTRY_CALLING_CODES: CountryCallingCode[] = [
  ...
  { code: "VC", name: "St. Vincent and Grenadines", dialCode: "1784" },
